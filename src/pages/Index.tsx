...
import { executeWithRetry, setupConnectionHeartbeat } from "@/utils/supabase-utils";
...
const Index = () => {
  ...
  // Função para transformar dados de vendas
  const transformSalesData = (salesData: any[]): Sale[] => {
    ...
    const fetchSales = async () => {
      try {
        ...
        toast({
          ...
          description: error instanceof Error ? error.message : "Houve um erro ao carregar as vendas do banco de dados.",
          variant: "destructive"
        });
      }
    };
  ...
  useEffect(() => {
    const fetchExpenses = async () => {
      try {
        ...
        console.log('Despesas carregadas com sucesso:', transformedExpenses.length);
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex gap-2 items-center">
              ...
              <Button variant="ghost" size="icon" onClick={() => setHideValues(v => !v)} title={hideValues ? "Mostrar valores" : "Ocultar valores"}>
